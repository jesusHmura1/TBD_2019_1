/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     14-06-2019 23:24:42                          */
/*==============================================================*/
...
(
   ...
   CALIFICACION_ESTUDIANTE int not null default 1,
...
(
   ...
   ID_PROYECTO          int not null,
   CALIFICACION_PROYECTO int not null default 1,
...
(
   ...
   DIFICULTAD_HABILIDAD int not null default 1,
...
(
   ...
   DIFICULTAD_REQUERIMIENTO int not null default 1,
